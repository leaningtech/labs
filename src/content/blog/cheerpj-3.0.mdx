...
CheerpJ 3.0, a state-of-the-art WebAssembly JVM that runs in the browser, is now officially available, and replaces CheerpJ 2.3 as our long-term supported version of CheerpJ.

We believe that this release brings a new era for deploying large scale Java applications on the Web, and for integrating Java libraries into Web apps. This is a moment of great pride for us at Leaning Technologies, and the culmination of two years of extremely focused work on the new CheerpJ 3.0 architecture.
...
- **A Virtualized system layer, including:**
  - [Virtualized file systems](/cheerpj3/File-System-support), providing access to assets over HTTP, local persistent R/W storage via IndexedDB and interaction with JavaScript data via `/str/`.
...
[TODO: video](https://browsercraft.cheerpj.com)
...
Other objectives for this project include multiplayer support and running a more modern version of Minecraft; for the sake of this demo we are using version 1.2.5. CheerpJ currently only supports Java 8, so we could at best reach version 1.2.5. More recent versions will need to wait for Java 11+ support, coming later in the year.

If you’re interested in contributing, or just curious, visit the [repository](https://github.com/leaningtech/browsercraft) and join [the #browsercraft channel in our Discord server](https://discord.gg/ZgY9tDAwxw).
...
For questions, discussion, and support, [join our Discord](https://discord.gg/3KwTYvVDZR). It’s an active community where both Leaning Technologies developers and experienced users can provide help.
