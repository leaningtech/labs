...
<div class="text-xl leading-normal">
	...
	now available! It replaces CheerpJ 2.3 as our long-term supported version of
	CheerpJ. Existing users can upgrade by following [the migration
	guide](/cheerpj3/migrating-from-cheerpj2). In this post, we'll give an
