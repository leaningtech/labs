...
Although CheerpJ 3.0 is not yet fully released, we are making it available to the public in the form of a release candidate: version 3.0rc2 is now available to the public. You can use it by simply adding a script tag to any HTML page:
