...
**CheerpJ can run extremely large and complex applications**: we recently stress-tested it on IntelliJ IDEA 2019, which ships ~400MB of JAR files. {/* TODO: LINK TO ALESSANDRO TWEET */}
...
**CheerpJ provides a completely unmodified build of OpenJDK.** Specifically, the most recent OpenJDK 8 revision. The architecture is designed to support multiple versions of Java, as well as custom runtimes. Future versions of CheerpJ will be compatible with Java 11, and newer LTS Java versions.
...
Although CheerpJ 3.0 is not yet fully released, we are making it available to the public in the form of a release candidate.

CheerpJ 3.0rc2 is now available to the public, you can use it by simply adding a script tag to any HTML page.
...
- Try the release candidate today in your real-world scenarios
- Report any bugs or issues you encounter on [GitHub](https://github.com/leaningtech/cheerpj-meta/issues)
- Join our [Discord](https://discord.leaningtech.com/) to share what you’re working on or suggest new features
