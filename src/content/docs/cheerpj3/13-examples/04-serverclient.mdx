...
4. Now open a browser tab and visit the address you are serving. It should be something similar to `http://127.0.0.1:8081/client.html`. You will see the CheerpJ loading animation for a brief moment and your application should show.
