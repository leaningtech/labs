...
5. Above the running application you will see the assigned IP address for the Server app. Please reserve it as you will need it later to connect the client with the server. You can also consult the IP address by visiting the [Tailscale Dashboard](https://login.tailscale.com/admin/machines).
...
3. Copy the Server's IP address from the Tailscale dashboard and paste it in the input field and hit enter. The Client app will try to connect to the Server app this way.
