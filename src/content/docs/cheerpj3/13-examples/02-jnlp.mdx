...
You will download the application JAR files by manually building their full URL and pasting it in the browser navigation bar. This is done by appending the `codebase` URL and the `jar` URL.
For example:
...
Create a directory where all the files will live. You can choose any name such `cheerpj-example-swingset3`:
...
You will download the applet JAR files by manually building the full URL and pasting it in the browser navigation bar. This is done by appending the `codebase` URL and the `jar` URL.
For example:
...
Create a directory where all the files will live. You can choose any name such `cheerpj-example-applet`:
