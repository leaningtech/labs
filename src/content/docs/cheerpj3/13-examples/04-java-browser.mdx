---
title: Java Browser (Networking)
description: Run a Java application with Internet connection
---

In this tutorial, we will take you step by step on how to use CheerpJ and Tailscale to run a simple Browser client application written in Java. This tutorial aims to give a basic understanding of how to set wider internet access to a Java application that runs with CheerpJ.
...
- Download the application JAR [here](/cheerpj3/examples/SwingHTMLBrowser.jar)
...
Functionality is simple, type the full URL of a website in the input field (e.g. `https://www.github.com/`) and press enter to load the page. This is a very basic example so the website will not render as in a modern browser but you will be able to see the hypertext.

<table>
	<tr>
		<td>
			<img src="/cheerpj2/assets/tinybrowser.png" width="350"></img>
		</td>
		<td>
			<img src="/cheerpj2/assets/tinybrowserloaded.png" width="344"></img>
		</td>
	</tr>
</table>

In this scenario, the page is loading because the machine you are running this application on has an active connection to the internet and Java OpenJDK is installed.

## 2. Running the application in the browser with CheerpJ
...
### What's happening until this point?
...
... But our application is a browser client, so we want it to have access to the Internet.

## 3. Connecting the application to the internet
...
It is essential to understand that a Java application running in the browser with CheerpJ needs to be connected and authenticated to the Tailscale network. Let's try by creating a pre-authenticated auth key:
...
Download the project template [here](/cheerpj3/examples/browserTutorial.zip).
