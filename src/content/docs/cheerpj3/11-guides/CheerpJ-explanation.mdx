...
CheerpJ assets are static, which makes it easily self-hostable, and we provide a cloud version under the [CheerpJ Community Licence](/cheerpj-3-deep-dive#licensing) (free to use for personal projects and technical evaluations).
...
![CheerpJ 3.0 architecture diagram](./src/content/blog/cheerpj-3-deep-dive-arch.png)
