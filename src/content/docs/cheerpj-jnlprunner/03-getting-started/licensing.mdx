...
The first time you launch a JNLP file to run a Java application, the JNLP Runner will be automatically detect it and it will start running. The first screen you will see is the license agreement. Please read this carefully and if you agree with the terms and conditions, click on _**Accept license**_
...
If your license key or license token are valid, you will be able to continue using the extension under the agreed terms and conditions. Please visit the next tutorial [_using the JNLP Runner for the first time._](/cheerpj-jnlprunner/getting-started/using-first-time)
