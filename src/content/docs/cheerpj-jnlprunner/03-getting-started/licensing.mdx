...
If your license key or license token is valid, you will be able to continue using the extension under the agreed terms and conditions. Please visit the next tutorial [_using the JNLP Runner for the first time._](/cheerpj-jnlprunner/getting-started/using-first-time)
