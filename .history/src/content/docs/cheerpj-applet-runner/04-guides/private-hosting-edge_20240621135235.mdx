...
The CRX file is a compressed format for browser extensions. To obtain the CRX file of the Applet runner extension for self-hosting, you will need to [contact us](https://cheerpj.com/contact/) and we will be happy to provide it for you alongside a license token.
...
The extension ID is a unique identifier you can easily retrieve from the [extension URL of Edge's Add-ons store](https://microsoftedge.microsoft.com/addons/detail/cheerpj-applet-runner/dpleickbpchmkpkmicanfolmianepfhe) (last 32 characters):

```
https://microsoftedge.microsoft.com/addons/detail/cheerpj-applet-runner/dpleickbpchmkpkmicanfolmianepfhe
```
