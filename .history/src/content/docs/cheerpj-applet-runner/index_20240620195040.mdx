...
import { products } from '../path/to/products'; // Adjust the path as needed
import { ProductData } from '../path/to/products';
...
const product: ProductData = products['cheerpj-applet-runner'];
---
