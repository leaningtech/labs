...
Please start by visiting the [Edge's add-on Applet Runner page](https://microsoftedge.microsoft.com/addons/detail/cheerpj-jnlp-runner/dpleickbpchmkpkmicanfolmianepfhe). Once there, please click on the button _**Get**_ to start the installation.
...
Your CheerpJ Applet extension must be already installed on your browser. The next step is to validate your license, please visit the [activate your license](/cheerpj-jnlp-runner/getting-started/licensing) tutorial.
