...
>
	<Card
		...
		description="CheerpJ Applet Runner is a browser extension that saves you from installing an outdated, insecure desktop Java installation."
	/>
	<Card
	...
	<Card
		...
		description="CheerpJ Applet Runner covers all your Java needs, including Swing/AWT, filesystem support, audio, clipboard, networking and more."
	/>
	<Card
		title="Easy to use"
		iconSrc={rocketIcon}
		iconAlt="Rocket doodle"
		description="Using our browser extension could not be easier. Just install, launch your Applet app as usual, and the extension will automatically start working."
	/>
</section>
