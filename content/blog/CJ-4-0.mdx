...
<div id="demodiv" class="w-full aspect-square relative">
	...
	<Icon id="demofullscreen" class="absolute right-0 bottom-0 w-8 h-8 mx-0.5 text-stone-900 cursor-pointer" name="fa-solid:expand" />
	<Icon id="demonormal" class="hidden absolute right-0 bottom-0 w-8 h-8 mx-0.5 text-stone-900 cursor-pointer" name="fa-solid:compress-arrows-alt" />
</div>
