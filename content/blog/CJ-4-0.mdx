...
<figure id="demodiv" class="w-full aspect-square relative">
	...
	<figcaption>A complex Swing application running live. Use the bottom-right control button to try it fullscreen.</figcaption>
</figure>
