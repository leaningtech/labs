...
<div id="demodiv" class="w-full aspect-square relative">
	<iframe class="absolute w-full h-full" src="https://cheerpj-example-swingset3.leaningtech.com/"></iframe>
	<Icon class="absolute right-0 bottom-0 w-4 h-4 mx-0.5" name="fa-solid:expand" />
</div>

<script>{`
debugger;
var demoDiv = document.getElementById("demodiv");
demoDiv.onlick = function()
{
debugger;
