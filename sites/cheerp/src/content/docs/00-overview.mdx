...
<div class="mt-5 mx-24 mx-auto p-4 bg-stone-800 rounded-lg shadow-md">
	...
	Have something in mind? Your contributions make a big difference. Dive into our
	project on GitHub and start making an impact today.
	<LinkButton
		type="secondary"
...
[Web workers]: /docs/tutorials/webworkers
