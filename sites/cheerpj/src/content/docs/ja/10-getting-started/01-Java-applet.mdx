...
このウェブページを簡単なHTTPサーバー、例えばhttp-serverユーティリティで提供できます。
...
Javaアプレットが含まれているページを訪問し、[例えばこのページ](http://www.neilwallis.com/projects/java/water/index.php)で、ツールバーにあるCheerpJアプレットランナーアイコンをクリックしてCheerpJを有効にします。
