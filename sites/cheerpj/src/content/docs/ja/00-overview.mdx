...
<div class="text-lg">
	CheerpJはWebAssemblyベースの **ブラウザ用Java仮想マシン**です。Java 8との広範な互換性が
	あり、Javaアプリケーション、アプレット、ライブラリ、およびJava Web Start / JNLPアプリケーション
	をプラグインなしでブラウザで実行するための完全なランタイム環境[^compat]を提供します。
</div>

<div class="m-4 flex justify-center">
	[始める](/docs/getting-started) · [例](/docs/tutorials) ·
	[APIリファレンス](/docs/reference) · [GitHubリポジトリ](https://github.com/leaningtech/cheerpj-meta)
</div>
