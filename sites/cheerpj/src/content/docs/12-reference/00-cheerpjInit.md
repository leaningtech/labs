...
> [!note] Important
> The `hostName` option is supported in CheerpJ 4.3 and later versions.
...
If this option is not provided, CheerpJ defaults to the arbitrary IP address `192.168.1.1`.
