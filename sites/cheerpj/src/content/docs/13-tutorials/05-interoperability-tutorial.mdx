...
- Inside this repository, navigate to the Interoperability tutorial and into the projectTemplate directory:

```sh
	cd examples/Interoperability/projectTemplate
```
...
We will do this in the `index.html` file, inside of the project template directory. In this file, you will find useful comments to guide you through the implementation process described below.
