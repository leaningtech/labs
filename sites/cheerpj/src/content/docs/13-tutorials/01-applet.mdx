...
- Inside this repository, navigate to the FoilSim-Applet tutorial and into the projectTemplate directory:

```sh
	cd examples/FoilSim-Applet/projectTemplate
```
...
## 2. Open `index.html` and add your applet content

The provided template is a basic HTML. You can add all the necessary elements yourself or alternatively, go ahead and replace the file with the code below.
The first step is to add the applet tag with its parameters, just like they used to be integrated on web pages. We will also add some titles, descriptions and styles.
