...
If you are not familiar with how CheerpJ and Tailscale work together, we invite you to take a look at our [Networking guide]. You can download the full template of this tutorial [here](%CJ_TUTORIALS_BASE%/ServerClientTutorial.zip%CJ_TUTORIALS_QUERY%).
...
> The downloadable ZIP is generated from the example source. If the CheerpJ loader URL changes, regenerate the ZIP with the packaging script.
...
2. Paste the application's JARs inside the corresponding folder.
  - [Download the Server JAR](%CJ_TUTORIALS_BASE%/Server.jar%CJ_TUTORIALS_QUERY%)
  - [Download the Client JAR](%CJ_TUTORIALS_BASE%/Client.jar%CJ_TUTORIALS_QUERY%)
...
You can download the full template of this tutorial [here](%CJ_TUTORIALS_BASE%/ServerClientTutorial.zip%CJ_TUTORIALS_QUERY%) or visit the [GitHub repository](https://github.com/leaningtech/cheerpj-meta/tree/main/examples/Server-Client).
