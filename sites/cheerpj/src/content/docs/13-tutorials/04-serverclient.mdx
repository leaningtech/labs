...
If you are not familiar with how CheerpJ and Tailscale work together, we invite you to take a look at our [Networking guide]. You can clone our tutorials [repository](https://github.com/leaningtech/cheerpj-meta.git) and navigate to `/examples/Server-Client` for the full template of this tutorial.
...
Visit the [GitHub repository](https://github.com/leaningtech/cheerpj-meta/tree/main/examples/Server-Client) for the full template of this tutorial.
