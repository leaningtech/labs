...
<img src="/public/cheerpj3/assets/Tailscale_P2P.png"></img>
...
![Client Server](../labs/public/cheerpj2/assets/client-server.png)
...
2. Paste the application's JARs inside the corresponding folder.
   - [Download the Server JAR](/docs/tutorials/Server.jar)
   - [Download the Client JAR](/docs/tutorials/Client.jar)
...
<div class="flex flex-row">
	<div class="w-1/2 mr-1 md:mr-2">
		![Server Browser](../labs/public/cheerpj2/assets/server-browser.png)
	</div>

    <div class="w-1/2 ml-1 md:ml-2">
    	![Client Browser](../labs/public/cheerpj2/assets/client-browser.png)
    </div>
