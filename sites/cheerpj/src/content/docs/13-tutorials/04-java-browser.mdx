...
- [Download `SwingHTMLBrowser.jar`](%CJ_TUTORIALS_BASE%/SwingHTMLBrowser.jar%CJ_TUTORIALS_QUERY%)
...
Download the project template [here](%CJ_TUTORIALS_BASE%/browserTutorial.zip%CJ_TUTORIALS_QUERY%) or visit the [GitHub repository](https://github.com/leaningtech/cheerpj-meta/tree/main/examples/Swing-Browser) for this tutorial.
