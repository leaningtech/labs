...
> [!important] Heads up
> The Java Swing application we are using as part of this tutorial includes empty JAR files
> resulting in a 416 Range Not Satisfiable error. This can be safely ignored.
