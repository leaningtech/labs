...
> [!important] Important
> We are using a Java Swing application to demonstrate what CheerpJ can do.
>
> This template project includes placeholder (empty) JAR files, which may trigger the following error:
> `http://localhost:5173/lib/MultipleGradientPaint.jar 416 (Range Not Satisfiable)`
>
> This error is expected and can be safely ignored. You can continue following the tutorial and experimenting with the project without issues.
