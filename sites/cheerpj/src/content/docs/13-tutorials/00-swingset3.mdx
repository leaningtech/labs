...
- [Download the template project](%CJ_TUTORIALS_BASE%/swingset3-template.zip%CJ_TUTORIALS_QUERY%) and unzip it
...
Let's add CheerpJ to the page by adding this script tag to the `<head:wq>`:
