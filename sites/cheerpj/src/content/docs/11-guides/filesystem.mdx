...
- **`fileChooser.showSaveDialog(this)`:** Displays the “Save” dialog so the user can pick a filename and location. *(Use `showOpenDialog(this)` when you want the user to select an existing file to open.)*
