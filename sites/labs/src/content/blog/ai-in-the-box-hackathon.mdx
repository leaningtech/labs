...
Last May 2026, Leaning Technologies and the Leeds Artificial Intelligence Society hosted **AI in the Box**, a 48-hour hackathon at Helix, University of Leeds, where every project had to run in a BrowserPod sandbox - our client-side sandbox for running untrusted code and applications securely inside the browser.
...
![A team outlining their project's technical architecture on a whiteboard](./ai-in-the-box-hackathon/whiteboard-work.jpg)

One of the most interesting aspects of the weekend was seeing how different teams interpreted the same challenge, with submissions varying significantly in both scope and approach.
...
What stood out most was that no two teams used BrowserPod in quite the same way. Although everyone started with the same challenge, the solutions that emerged reflected a wide range of technical interests, problem domains, and ideas. That diversity ultimately made judging one of the hardest parts of the weekend.

## Judging the Projects

![A participant presenting their project to the judges and attendees](./ai-in-the-box-hackathon/presentation.jpg)

Projects were evaluated by a judging panel representing Leaning Technologies, DRS Software, and the Leeds Artificial Intelligence Society:

- **Ana Gaby Reyna** (Software Engineer / DevRel at Leaning Technologies)
- **Mohammad Tasfiq Jawaad** (President of Leeds Artificial Intelligence Society)
- **Martin Nyaga** (Software Engineer at DRS Software)
- **Scott Langridge** (Software Engineer at DRS Software)
...
![The hackathon participants and organizers group photo at the end of the event](./ai-in-the-box-hackathon/group.jpg)
