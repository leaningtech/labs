...
> [!note] Undecorated Applet frames
...
<div class="mx-24">
	...
	integrated into its title bar](/assets/applet-screenshots/titlebar-upload.png)
</div>
...
2. Click the **CheerpJ icon** in your browser's toolbar and click the **Upload** button.
   ...
   <div class="mx-24">
   	...
   	running](/assets/applet-screenshots/popup-upload.png)
   </div>
