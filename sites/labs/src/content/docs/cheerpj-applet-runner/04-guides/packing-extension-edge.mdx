...
description: Tutorial for packing the CheerpJ Applet Runner Extension in Edge for deployment
---

This tutorial will walk you through the steps to pack the CheerpJ Applet Runner extension in Edge, making it ready for distribution and deployment, particularly useful in enterprise environments like deploying through Group Policy Objects (GPOs).
...
<div class="mx-24">
	![](/assets/edge-applet-pack-screenshots/edge-pack-applet-select.png)
</div>
...
<div class="mx-24">
	![](/assets/edge-applet-pack-screenshots/edge-pack-applet-created.png)
</div>
...
<div>![](/assets/edge-applet-pack-screenshots/edge-pack-applet-drag.png)</div>

Click on `Add extension`:

<div>
	![](/assets/edge-applet-pack-screenshots/edge-pack-applet-confirm.png)
</div>

Now you should see the extension has been successfully installed:

<div>
	![](/assets/edge-applet-pack-screenshots/edge-pack-applet-success.png)
</div>

By following these steps, you will have successfully packed your CheerpJ Applet Runner extension for Edge, ready for deployment or testing.
