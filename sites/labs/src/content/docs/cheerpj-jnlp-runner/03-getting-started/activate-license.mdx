...
- **License Key (Most Users)**: You can purchase a license key from the [_**Leaning Technologies shop**_](/payment-jnlp) and activate it by following the **Activation via license key** section.
...
In order to activate your license, click on the _**Manage License**_ button on the extension's sidepanel that appears when running an JNLP or the popup.

<div style="display: flex; justify-content: center; align-items: center; gap: 24px; width: 30%; height: 40%; margin: 0 auto;">
	<img
		src="/assets/jnlp-screenshots/sidepanel_license.png"
		alt="Home screen"
		style="max-width: 100%; height: auto;"
	/>
	<img
		src="/assets/jnlp-screenshots/popup_license.png"
		alt="Popup"
		style="max-width: 100%; height: auto;"
	/>
</div>
...
<div class="mx-24">![](/assets/jnlp-screenshots/enter_license.png)</div>
...
If you have been provided with a license token, you can activate your license offline. From the extension's home screen or popup, click on the _**Manage License**_ link, then select _**Enter License**_. Choose the _**Token**_ option, enter your license token and click on the _**Validate**_ button.
