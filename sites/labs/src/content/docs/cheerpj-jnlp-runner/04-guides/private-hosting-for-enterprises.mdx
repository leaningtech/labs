...
description: How to self host the CheerpJ JNLP Runner extension
---

This guide is designed to assist enterprise users in privately hosting the CheerpJ JNLP Runner extension.
...
To self-host the CheerpJ JNLP Runner extension, you will need a web server to host the extension’s `CRX` and `manifest.xml` files.
...
For enterprise users, you may have already received the JNLP Runner's CRX file from us, or we may have sent you the extension files in a compressed folder.
In the latter case, you will need to pack the extension yourself. We provide detailed documentation on how to do this for [Chrome](/docs/cheerpj-jnlp-runner/guides/packing-extension-chrome) and
[Edge](/docs/cheerpj-jnlp-runner/guides/packing-extension-edge).
...
To further configure the extension you can follow our documentation on how to [configure extensions for enteprises](/docs/cheerpj-jnlp-runner/guides/configure-extension-for-enterprises).
