...
Create an ext2 filesystem by combining a [`HttpBytesDevice`](/docs/reference/CheerpX.HttpBytesDevice) to acess disk blocks, an [`IDBDevice`](/docs/reference/CheerpX.IDBDevice) to cache and persist data and a [`OverlayDevice`](/docs/reference/CheerpX.OverlayDevice) to combine the two.
...
1. [**HttpBytesDevice**](/docs/reference/CheerpX.HttpBytesDevice): The default choice for loading filesystem images via HTTP. Suitable for most web-hosted files.
